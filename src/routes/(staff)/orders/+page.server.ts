...
/**
 * show prints section with:
 *  - download links (signed URLs generated by admin helper),
 *  - clear specs for each image (size, quantity, cropMode),
 *  - "Download original" button which triggers the admin download URL or direct storage access.
 *  - The user stories require staff be able to download full, uncompressed images and see specs.
 * 
 */