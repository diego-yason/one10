...
<form method="POST" class="flex py-10 justify-evenly">
			...
			<div class="flex flex-col space-y-10">
				{#if !$user}
					<div>
						...
						<input
							...
							class="bg-white p-3 text-gray-800 w-full {errors.email && touched.email
					...
					<div>
						...
						<input
							...
							on:input={(e) => {
								...
								handleInput('fullName', fullName);
							}}
							placeholder="Full name"
							class="bg-white p-3 text-gray-800 w-full {errors.fullName && touched.fullName
								? 'border-2 border-red-500'
								: ''}"
						/>
				...
				<div>
					...
					<input
						...
						placeholder="Address"
						class="bg-white p-3 text-gray-800 w-full {errors.address && touched.address
							? 'border-2 border-red-500'
							: ''}"
					/>
				...
				<div>
					...
					<input
						...
						placeholder="City"
						class="bg-white p-3 text-gray-800 w-full {errors.city && touched.city
							? 'border-2 border-red-500'
							: ''}"
					/>
			...
			<div class="grid grid-cols-2 gap-4">
				<div>
					...
					<input
						type="text"
						bind:value={zip}
						on:blur={() => handleBlur('zip')}
						on:input={(e) => handleInput('zip', e.target.value)}
						placeholder="Zip / postal code"
						class="bg-white p-3 text-gray-800 w-full {errors.zip && touched.zip
							? 'border-2 border-red-500'
							: ''}"
					/>
				...
				<div>
					...
					<input
						...
						placeholder="Phone"
						class="bg-white p-3 text-gray-800 w-full {errors.phone && touched.phone
							? 'border-2 border-red-500'
							: ''}"
					/>
