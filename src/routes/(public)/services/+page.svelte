		...
		{#if !selectedService}
			...
			>
				...
				>
					...
					/>
					<div
						class="bg-amber-300 flex flex-col items-center justify-center rounded-b-2xl pt-2 pb-2"
					>
							...
							>
								<div class="w-full">
									...
									<p class="product-2-font truncate-name">
										<a href={`/product/${product.id}`} class="hover:text-amber-400"
											>{product.name}</a
										>
									</p>
								</div>
