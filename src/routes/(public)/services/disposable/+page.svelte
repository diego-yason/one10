...
function handleFieldChange(field: string, value: string) {
	...
	const error = validateField(disposableSchema, field as keyof typeof disposableSchema.shape, value);
	if (error) {
...
<div class="flex flex-col max-w-4xl w-full ml-32 mx-auto">
    ...
    <form on:submit={handleSubmit} class="w-full flex flex-col gap-6">
        <div>
            ...
            <input 
                type="text" 
                class="w-full px-4 py-2 rounded border border-gray-300 bg-white {fieldErrors.filmBrand ? 'border-2 border-red-500' : ''}" 
        ...
        <div>
            ...
            <select 
                class="w-full px-4 py-2 rounded border border-gray-300 bg-white {fieldErrors.processType ? 'border-2 border-red-500' : ''}"
        ...
        <div>
            ...
            <select 
                class="w-full px-4 py-2 rounded border border-gray-300 bg-white {fieldErrors.returningNegatives ? 'border-2 border-red-500' : ''}"
