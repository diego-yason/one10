...
<div class="flex flex-col max-w-4xl w-full ml-32 mx-auto">
    ...
    <form class="w-full flex flex-col gap-6">
        ...
        <div>
            ...
            <input type="text" class="w-full px-4 py-2 rounded border border-gray-300 bg-white" placeholder="Enter total number of photos" />
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" class="w-full px-4 py-2 rounded border border-gray-300 bg-white" placeholder="Paste the link your photos" />
        </div>
        <div class="mt-4">
            <label class="block font-bold mb-2 text-sm">MODE OF DELIVERY FOR DROP-OFF*</label>
            <div class="flex flex-col gap-2">
                <label class="text-sm"><input type="radio" name="dropoff" /> SAME DAY COURIER (LALAMOVE, GRAB, MR. SPEEDY, ETC.)</label>
                <label class="text-sm"><input type="radio" name="dropoff" /> COURIER (JRS, LBC, J&T, GOGOEXPRESS, ETC.)</label>
                <label class="text-sm"><input type="radio" name="dropoff" /> DROP-OFF AT LOCATION (ONE10STUDIOLAB, MUNTINLUPA CITY)</label>
                <label class="text-sm"><input type="radio" name="dropoff" /> OTHER: <input type="text" class="ml-2 px-2 py-1 rounded border border-gray-300 bg-white inline-block w-40" placeholder="Specify" /></label>
            </div>
        </div>
        <div class="mt-4">
            <label class="block font-bold mb-2 text-sm">MODE OF DELIVERY FOR PICK-UP*</label>
            <div class="flex flex-col gap-2">
                <label class="text-sm"><input type="radio" name="pickup" /> SAME DAY COURIER (LALAMOVE, GRAB, MR. SPEEDY, ETC.)</label>
                <label class="text-sm"><input type="radio" name="pickup" /> COURIER (JRS, LBC, J&T, GOGOEXPRESS, ETC.)</label>
                <label class="text-sm"><input type="radio" name="pickup" /> DROP-OFF AT LOCATION (ONE10STUDIOLAB, MUNTINLUPA CITY)</label>
                <label class="text-sm"><input type="radio" name="pickup" /> OTHER: <input type="text" class="ml-2 px-2 py-1 rounded border border-gray-300 bg-white inline-block w-40" placeholder="Specify" /></label>
            </div>
        </div>
